...
Las especificaciones te suministran dos clases hijos de Madre (`Mother`), así que solo debes implementar el método de clase `phone_kids`. Tal vez necesites el método [`inherited`](https://ruby-doc.org/3.3.5/Class.html#method-i-inherited) de `Class`.
