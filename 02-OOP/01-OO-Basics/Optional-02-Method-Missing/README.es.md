...
Para entender cómo y cuándo Ruby llama al `method_missing` ([docs here](https://ruby-doc.org/3.3.5/BasicObject.html#method-i-method_missing)) te recomendamos leer [este artículo](https://blog.appsignal.com/2019/05/07/method-missing.html).

Tal vez también quieras leer sobre como Ruby te deja [get](https://ruby-doc.org/3.3.5/Object.html#method-i-instance_variable_get) o [set](https://ruby-doc.org/3.3.5/Object.html#method-i-instance_variable_set) una variable de instancia dinámicamente.
