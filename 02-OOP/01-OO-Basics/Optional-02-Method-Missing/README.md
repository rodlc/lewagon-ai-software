...
You can read [this article](https://blog.appsignal.com/2019/05/07/method-missing.html) to get a sense of how and when Ruby calls `method_missing` ([docs here](https://ruby-doc.org/3.3.5/BasicObject.html#method-i-method_missing)).

You may also want to read how Ruby lets you dynamically [get](https://ruby-doc.org/3.3.5/Object.html#method-i-instance_variable_get) or [set](https://ruby-doc.org/3.3.5/Object.html#method-i-instance_variable_set) an instance variable.
