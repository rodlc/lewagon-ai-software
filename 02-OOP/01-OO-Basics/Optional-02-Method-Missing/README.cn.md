...
你可以阅读[这篇文章](https://blog.appsignal.com/2019/05/07/method-missing.html)了解Ruby如何以及何时调用`method_missing` ([相关文档](https://ruby-doc.org/3.3.5/BasicObject.html#method-i-method_missing)).

你可能还想了解Ruby是如何让你动态地[得到](https://ruby-doc.org/3.3.5/Object.html#method-i-instance_variable_get) or [设置](https://ruby-doc.org/3.3.5/Object.html#method-i-instance_variable_set)实例变量.
