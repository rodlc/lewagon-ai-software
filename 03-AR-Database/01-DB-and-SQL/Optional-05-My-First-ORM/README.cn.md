...
- 你可以用[`instance_variable_set`](http://ruby-doc.org/3.3.5/Object.html#method-i-instance_variable_set)动态地设置一个实例变量。
- 你可以用[`instance_variable_get`](http://ruby-doc.org/3.3.5/Object.html#method-i-instance_variable_get)动态地读取一个实例变量。
