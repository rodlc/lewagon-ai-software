...
- Tu peux dynamiquement définir une variable d'instance avec [`instance_variable_set`](http://ruby-doc.org/3.3.5/Object.html#method-i-instance_variable_set)
- Tu peux dynamiquement lire une variable d'instance avec [`instance_variable_get`](http://ruby-doc.org/3.3.5/Object.html#method-i-instance_variable_get)
