...
Find the right Ruby methods of the [String class](http://ruby-doc.org/3.3.5/String.html), the [Integer class](http://ruby-doc.org/3.3.5/Integer.html), and the [Array class](http://ruby-doc.org/3.3.5/Array.html) to plug in and make the tests pass.
