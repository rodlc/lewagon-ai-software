...
找到并填入正确的[字符串类](http://ruby-doc.org/3.3.5/String.html)、[整数类](http://ruby-doc.org/3.3.5/Integer.html )，以及[数组类](http://ruby-doc.org/3.3.5/Array.html)的Ruby方法（methods），以使测试通过。
