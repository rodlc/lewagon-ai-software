...
To better understand `yield`, let's try to reimplement the [`Enumerable#map`](https://ruby-doc.org/3.3.5/Enumerable.html#method-i-map) method without actually using it.
